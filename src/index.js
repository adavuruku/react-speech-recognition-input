...
export default class App extends Component {
  ...
  componentDidMount() {
    if (this.state.supportVoice) {
      ...
      this.recognition.lang = this.props.lang || 'pt-BR';
        ...
        for (let i = event.resultIndex; i < event.results.length; ++i) {
          if (event.results[i].isFinal) {
            ...
            this.setState((oldState) => {
              return oldState.inputValue= finalTranscript
            });
            this.say()
            setTimeout(()=>{
              this.say()
            ...
            this.setState((oldState) => {
              return oldState.inputValue = interimTranscript
            });
  ...
  changeValue(event) {
    this.setState((oldState) => {
      return oldState.inputValue = event.target.value
    });
  }
